...
@SuppressLint("NewApi")
public class PlayMultipleSurfaceView extends SurfaceView implements Callback {
    ...
    public PlayMultipleSurfaceView(viewBuildingCamera building_camera_view) {
...
//        struRect.bottom =  new_bottom;//(int)(struRect.bottom * mScaleFactor);//(int)focusY;
      *//*  struRect.left = (int)(focusX/scale_factor);
        ...
        struRect.right = surface_width;//(int)focusX;
        struRect.bottom = surface_height; //(int)focusY;*//*
