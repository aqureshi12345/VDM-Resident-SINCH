...
import com.vdm.virtualdoorman.LogsFragments.LogsContainerFragment;
...
public class logs extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrivals.setBackgroundResource(R.drawable.arrivals);
        ImageView logs=(ImageView)findViewById(R.id.logs);
        logs.setBackgroundResource(R.drawable.logs_s);
        ...
        fragment = new LogsContainerFragment();
                            ...
                            alertDialogBuilder.setPositiveButton(
                                    ...
                                    new DialogInterface.OnClickListener() {
                                        ...
                                        public void onClick(DialogInterface arg0,
                                            ...
                                            Intent reload = new Intent(logs.this,
